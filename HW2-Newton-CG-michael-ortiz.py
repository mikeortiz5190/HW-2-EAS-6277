...
def fun_hess(x):
    return Hessian(lambda x: objective_function(x))(x)
...
ax.set_title('Newton w/init guess: c1=100,c2=110,c3=120')
...
ax2.set_title('Newton w/init guess: c1=100,c2=110,c3=120')
